...
class UserNotificationService implements UI.UserNotification {
  ...
  notifyReadAllAddressBookSubject = new Subject<$kotlin.collections.List<string>>();
  ...
  notifyReadAllContactSubject = new Subject<$kotlin.collections.List<string>>();
  ...
  notifyReadAllAddressBookTitles(session: info.UserSession, all: $kotlin.collections.List<string>): void {
  ...
  notifyReadAllContact(session: info.UserSession, all: $kotlin.collections.List<string>): void {
